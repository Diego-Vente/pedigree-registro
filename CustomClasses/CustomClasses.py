...
class RoundedButton(tk.Canvas):
    ...
    def __init__(self, master=None, text: str = "", radius=30, btnforeground="#000000", btnbackground="#ffffff",
        ...
        self.text = self.create_text(0, 0, text=text, tags="button", fill=btnforeground, font=("Times", 13),
                                     justify="center")
